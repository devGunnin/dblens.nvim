...
M.specs = {
  ...
  sidebar = {
    ...
    },
    {
      action = 'open_tab',
      lhs = 't',
      desc = 'Open the table in a new result tab',
      mode = 'n',
      group = 'table',
    },
    ...
    { action = 'ddl', lhs = 'D', desc = 'Show the DDL', mode = 'n', group = 'table' },
    {
      action = 'export',
      lhs = 'X',
      desc = 'Export the table to a file',
      mode = 'n',
      group = 'table',
    },
  ...
  results = {
    ...
    { action = 'first_page', lhs = '[P', desc = 'First page', mode = 'n', group = 'inspect' },
    ...
    {
      action = 'filter_not_cell',
      lhs = '!',
      desc = 'Filter out this value',
      mode = 'n',
      group = 'inspect',
    },
    {
    ...
    },
    {
      action = 'tab_list',
      lhs = 'gl',
      desc = 'List the open results',
      mode = 'n',
      group = 'tabs',
    },
    { action = 'search', lhs = 'g/', desc = 'Search the result', mode = 'n', group = 'search' },
    { action = 'next_match', lhs = 'gn', desc = 'Next match', mode = 'n', group = 'search' },
    { action = 'prev_match', lhs = 'gN', desc = 'Previous match', mode = 'n', group = 'search' },
  ...
  editor = {
    ...
    },
    {
      action = 'run_new_tab',
      lhs = '<localleader>t',
      desc = 'Run into a new result tab',
      mode = 'n',
      group = 'run',
    },
    {
